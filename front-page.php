    ...
    <div class="about-us" id="about">
        <div class="col">                        
            ...
            <div class="about-text">
                <p>M&amp;L BurgerHaus nace en Donosti con la intención de acercar esta ciudad, tan dada a la buena gastronomía, a un producto que en los últimos años ha dejado de ser considerado comida basura y se ha convertido en una comida saludable y gourmet.</p>
        ...
        <div class="col">                        
            <h2 class="main-title">¿Qué hacemos?</h2>
            <div class="about-text">
                ...
                <p>Por ello ofrecemos unas hamburguesas diferentes a cualquier otra del mercado, con unos sabores vivos y una jugosidad y frescura que no se encuentra en otra parte. Todo ello utilizando productos de la tierra, ya que siempre hemos creído en promover el producto local y aprovechar su alto nivel de calidad.</p>
                <p>En M&amp;L no nos olvidamos de nadie y es por eso que ofrecemos opciones para todo tipo de gustos: hamburguesas de ternera, de pollo y vegetarianas. Siendo esta último de un concepto que nada tiene que ver con el resto de hamburguesas vegetarianas del mercado.</p>                        
            </div>                         
        </div>
    </div>
